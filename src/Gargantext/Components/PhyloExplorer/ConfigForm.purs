    ...
    pure $
          ...
          ,
            ...
            ,
              ...
              ,
                ...
                ,
                  B.if' (fv.hasError' "matchingFrame") $
                    H.div
                    { className: "form-group__error" }
                    [
                      H.text "Please enter an `Int` value (eg. 3)"
      ...
      ,
        ...
        [
          ...
          ,
            -- TYPE::FIS_
            B.if' (state.cliqueType == show FIS_) $
          ...
          ,
            -- TYPE::MaxClique_
            B.if' (state.cliqueType == show MaxClique_) $
